...
{
    /// <summary>
    /// 肩射模式（按住右键）：切到瞄准相机做"过肩"视角，FOV 轻微缩小，便于交战。
    /// </summary>
    public class FPSShoulderMode : FPSAimModeBase
    {
